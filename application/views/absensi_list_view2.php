            ...
            <div class="col-lg-12">
                <div class="hpanel">
                    <div class="panel-body">
                        ...
                        <br>
                        <a class="btn btn-primary" href="<?php echo base_url('absensi/create') ?>"><i class="fa fa-plus "></i> Tambah Data Absensi</a>
                        <br><br>
                            ...
                            <tbody>
                                ...
                                ?>
                                    ...
                                    <?php 
                                        ...
                                        echo ' ';
                                        echo anchor(site_url('absensi/delete/'.$absensi->id),' Ubah ','<a class="badge badge-success"','</a>'); 
